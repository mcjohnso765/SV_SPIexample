...
COMPONENT_FILES	:= spi_interface.svh slave.sv

# Specify the name of the top level file (do not include the source folder in the name)
TOP_LEVEL_FILE	:= master.sv
...
sim_source:
	...
	@$(COMPILE) -work source_work $(addprefix source/, $(TEST_BENCH)) >> source.comp
...
create_clock "Clk_i" -name "Clk_i" -period 2                                                \n\
                                                                                        \n\
